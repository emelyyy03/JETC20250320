...
using JETC20250320.Models;

namespace JETC20250320.Controllers
{
    public class WarehousController : Controller
    {
        private readonly Test20250320DbContext _context;

        public WarehousController(Test20250320DbContext context)
        {
            _context = context;
        }
